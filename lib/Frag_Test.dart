...
class Data {
  ...
  List<Fragen> _dieFragen = [
    Fragen(
        fragen_Actuel: 'Berlin ist Hauptstadt von Deutscland',
        image: Image.asset('assets/berlin1.jpg'),
        antwort: true),
    Fragen(
        fragen_Actuel: 'Deutschland hat 10 Bundesland',
        image: Image.asset('assets/eyalet2.jpg'),
        antwort: false),
    Fragen(
        fragen_Actuel:
            'Die deutsche Nationalmannschaft  hat das letzte Turnier gewonnen',
        image: Image.asset('assets/milli3.jpg'),
        antwort: false),
    Fragen(
        fragen_Actuel: 'Mercedes ist eine italienische Marke ',
        image: Image.asset('assets/mercedes4.jpg'),
        antwort: false),
    Fragen(
        fragen_Actuel: 'Die Turken leben auch in Koln',
        image: Image.asset('assets/koln5.jpg'),
        antwort: true),
    Fragen(
        fragen_Actuel: '',
        image: Image.asset('assets/koln5.jpg'),
        antwort: true),
    Fragen(
        fragen_Actuel: 'kaybettin',
        image: Image.asset('assets/aglayan7.png'),
        antwort: true),
    Fragen(
        fragen_Actuel: 'kazandin',
        image: Image.asset('assets/gulen6.jpg'),
        antwort: true)
  ];
  ...
  String getFragtArtikel(int point) {
    ...
    if (fragen_Count + 3 == dieFragen.length) {
      if (point > 0) {
        ...
        fragen_return = _dieFragen[dieFragen.length - 2].fragen_Actuel;
      }
    }
  ...
  Image getimage(int point) {
    ...
    if (fragen_Count + 3 == dieFragen.length) {
      if (point > 0) {
        ...
        image = _dieFragen[dieFragen.length - 2].image;
      }
    }
    return image;
  }
